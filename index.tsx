...
@customElement('examples-button')
export class ExamplesButton extends IconButton {
  override renderIcon() {
    // A few sparkles to represent "examples" or "inspiration"
    return svg`<path d="M70 35 L72 45 L82 47 L72 49 L70 59 L68 49 L58 47 L68 45 Z" fill="#FEFEFE" />
<path d="M50 60 L52 65 L62 67 L52 69 L50 79 L48 69 L38 67 L48 65 Z" fill="#FEFEFE" />
<path d="M90 60 L92 65 L102 67 L92 69 L90 79 L88 69 L78 67 L88 65 Z" fill="#FEFEFE" />`;
  }
}
...
class SettingsController extends LitElement {
  ...
  // FIX: Explicitly type defaultConfig to match LiveMusicGenerationConfig.
